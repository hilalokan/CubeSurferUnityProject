...
{
    private float stepLength = 0.0409f;
    private float groundYValue = -0.08f;
    ...
    private void RelocatePlayer()
    {
        ...
        var yValue = (listOfCubeBehaviour.Count) * stepLength + groundYValue;
        Vector3 playerTarget = new Vector3(0.0099f, yValue, 0f);
    ...
    public void DropCube(CubeBehaviour cubeBehaviour)
    {
        ...
        Debug.Log(listOfCubeBehaviour.Count);
